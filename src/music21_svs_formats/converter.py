...
class LibresvipSubConverter(music21.converter.subConverters.SubConverter):
    ...
    def parseFile(self, filePath: str | pathlib.Path, number:Optional[int]=None, **keywords) -> music21.stream.Score:
    ...
    def parseData(self, dataStr: str | bytes, number:Optional[int]=None) -> music21.stream.Score:
